...
LayoutList.prototype ={
    Init : function(){
        ...
        var parentLayout = this.layout = new FDLayout(this.ctx, this.channel, this.graph,
            new CameraView(this.channel, this.settings.colourScheme, window.innerWidth, window.innerHeight),
            this.settings);
    ...
    AddLayout : function(parentLayout, entry){
        ...
        return new FDLayout(this.ctx, this.channel,infoGraph,
            new CameraView(this.channel,this.settings.colourScheme, 200, 200), this.settings, entry, parentLayout, centreNode);
