...
export function CameraView(channel, colourScheme, startwidth, startheight) {
...
CameraView.prototype = {
    ...
    UpdatePosition: function (_dir) {
        ...
        // $('#cdup').html(Math.round(this.zoompercentage));
        ...
        this.channel.emit( "cameradebug",  {value: debugData});
    },
