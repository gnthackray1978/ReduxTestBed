...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"Libs/Panels.js":[function(require,module,exports) {
var Panels = function Panels() {};

Panels.prototype = {
  genericShowPanel: function genericShowPanel(panel) {
    if (panel == 1) {
  ...
  marriagesShowPanel: function marriagesShowPanel(panel) {
    if (panel == 1) {
      $("#pMain").removeClass("hidePanel").addClass("displayPanel");
      $("#pMore").removeClass("displayPanel").addClass("hidePanel");
    }
  ...
  personsShowPanel: function personsShowPanel(panel) {
    if (panel == 1) {
      $("#pMain").removeClass("hidePanel").addClass("displayPanel");
      $("#pMore").removeClass("displayPanel").addClass("hidePanel");
    }
  ...
  answerPanel: function answerPanel(panel) {
    if (panel == 1) {
      $("#pMain").removeClass("hidePanel").addClass("displayPanel");
      $("#pMore").removeClass("displayPanel").addClass("hidePanel");
    }
  ...
  sourcesShowPanel: function sourcesShowPanel(panel) {
    if (panel == 1) {
      $("#pMain").removeClass("hidePanel").addClass("displayPanel");
      $("#pMore").removeClass("displayPanel").addClass("hidePanel");
  ...
  masterShowTab: function masterShowTab(panel) {
    if (panel == 1) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "11945" + '/');
...
},{}]},{},["../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","Libs/Panels.js"], null)
//# sourceMappingURL=/Panels.e0f4fc1a.map