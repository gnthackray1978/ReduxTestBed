...
},{"buffer":"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"Libs/postal.js":[function(require,module,exports) {
var define;
var global = arguments[3];
  ...
  */
  ...
  var bindingsResolver = _config.resolver = {
    ...
    compare: function compare(binding, topic, headerOptions) {
      ...
      var saveToCache = this.enableCache && !opt.resolverNoCache; // result is cached?
    ...
    if (typeof options === "function") {
      ...
      return function (sub) {
        ...
        _.each(options, function (val, prop) {
          ...
          if ( // We use the bindings resolver to compare the options.topic to subDef.topic
          prop === "topic" && resolver.compare(sub.topic, options.topic, {
            resolverNoCache: true
          }) || prop === "context" && options.context === sub._context // Any other potential prop/value matching outside topic & context...
  ...
  _.extend(postal, {
    ...
    subscribe: function subscribe(options) {
      ...
      subs.push(subDef); // Next, add the SubscriptionDefinition to any relevant existing cache(s)

      _.each(this.cache, function (list, cacheKey) {
        if (cacheKey.substr(0, channelLen) === subDef.channel) {
          getCacher(cacheKey.split(_config.cacheKeyDelimiter)[1], list, cacheKey)(subDef);
        }
      });
      /* istanbul ignore else */
    ...
    unsubscribe: function unsubscribe() {
      ...
      for (; unSubIdx < unSubLen; unSubIdx++) {
        ...
        if (topicSubs) {
          ...
          idx = 0; // remove SubscriptionDefinition from channel list
...
},{"lodash":"../node_modules/lodash/lodash.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "14494" + '/');
...
},{}]},{},["../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","Libs/postal.js"], null)
//# sourceMappingURL=/postal.c4a27263.map