...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"Libs/View.js":[function(require,module,exports) {
"use strict";
...
function View(mitt) {
  ...
  this.hello = 'hello again';
  this.emitter = mitt;
}

View.prototype.Save = function (action) {
  console.log('view saved'); // fire an event

  this.emitter.emit("mouseDoubleClick", {
    value: 1
  });
};
...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"logo.svg":[function(require,module,exports) {
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          others = _objectWithoutProperties(_this$props, ["variant", "content"]);
...
function (_React$Component2) {
  _inherits(TopButtons, _React$Component2);
  ...
  function TopButtons(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(TopButtons).call(this, props));
    var emitter = (0, _mitt.default)();
    _this.state = {
      test: new _View.View(emitter),
      bollocks: 'bollocks'
    };
    return _this;
  }
...
function (_React$Component3) {
  _inherits(DiagramContainer, _React$Component3);

  function DiagramContainer(props) {
    var _this2;

    _classCallCheck(this, DiagramContainer);

    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(DiagramContainer).call(this, props));
    var emitter = (0, _mitt.default)();
    _this2.state = {
      test: new _View.View(emitter),
      bollocks: 'bollocks'
  ...
  _createClass(DiagramContainer, [{
    key: "render",
    value: function render() {
      return _react.default.createElement("div", {
        className: "App"
      }, _react.default.createElement(TopButtons, null));
    }
  }]);
...
_reactDom.default.render(_react.default.createElement(DiagramContainer, null), document.getElementById('root')); // Hot Module Replacement


if (module.hot) {
  module.hot.accept();
}
},{"./Libs/View":"Libs/View.js","mitt":"../node_modules/mitt/dist/mitt.es.js","react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","/logo.svg":"logo.svg","/main.css":"main.css"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
